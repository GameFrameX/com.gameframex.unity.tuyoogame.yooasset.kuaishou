...
namespace GameFrameX.Asset.YooAsset.Minigame.KuaiShou.Runtime
{
    ...
    internal class LoadKuaiShouPackageManifestOperation : AsyncOperationBase
    {
        [UnityEngine.Scripting.Preserve]
        private enum ESteps
        {
        ...
        [UnityEngine.Scripting.Preserve]
        internal LoadKuaiShouPackageManifestOperation(KuaiShouFileSystem fileSystem, string packageVersion, string packageHash, int timeout)
        {
        ...
        {
            _requestCount = WebRequestCounter.GetRequestFailedCount(_fileSystem.PackageName, nameof(LoadKuaiShouPackageManifestOperation));
        ...
        public override void InternalOnUpdate()
        {
            ...
            if (_steps == ESteps.RequestFileData)
            {
                ...
                else
                {
                    ...
                    WebRequestCounter.RecordRequestFailed(_fileSystem.PackageName, nameof(LoadKuaiShouPackageManifestOperation));
                }
            }
